            ...
            <div className="box_item box_join">
                <table class="join_table">
                    ...
                    <tr class="detail">
                        <td></td>
                        <td>
                        개인정보보호법에 따라 토마토에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
                        </td>
                    </tr>
                    <tr class="title">
                        <td>
                    ...
                    <tr class="detail">
                        <td></td>
                        <td>
                        위치기반서비스 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 토마토 위치기반 서비스를 이용할 수 있습니다.
                        </td>
                    </tr>
                </table>                
                <input 
